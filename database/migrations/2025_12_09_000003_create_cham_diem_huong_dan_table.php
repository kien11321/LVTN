...
return new class extends Migration
{
    ...
    {
        Schema::create('cham_diem_huong_dan', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('detai_id');
            $table->unsignedBigInteger('sinhvien_id');
            $table->unsignedBigInteger('giangvien_id'); // GVHD chấm
            ...
            $table->unique(['detai_id', 'sinhvien_id', 'giangvien_id'], 'cdhd_unique');
    ...
    {
        Schema::dropIfExists('cham_diem_huong_dan');
    }
};
