        ...
        <form method="POST" action="{{ route('phancong-detai.store-simple') }}">
            ...
            <div class="form-row-inline">
                <div class="form-group-inline">
                    ...
                    <select id="nhom_id" name="nhom_id" class="form-control-inline" required onchange="showCurrentDetai(this)">
                ...
                <div class="form-group-inline flex-grow">
                    ...
                    >
                    <small id="current-detai-hint" class="text-muted" style="display: none; font-size: 12px; margin-top: 3px;"></small>
                </div>
