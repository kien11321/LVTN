                ...
                <form method="POST" action="{{ route('cham-diem-pb.store') }}" class="score-form">
                    ...
                    <div class="nhan-xet-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="nhan_xet_tong_quat" rows="3" class="form-control">
                                {{ $firstDiem->nhan_xet_tong_quat ?? '' }}
                            </textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <label><input type="radio" name="thuyet_minh" value="dat"
                                        {{ ($firstDiem->thuyet_minh ?? 'dat') == 'dat' ? 'checked' : '' }}> Đạt</label>
                                <label><input type="radio" name="thuyet_minh" value="khong_dat"
                                        {{ ($firstDiem->thuyet_minh ?? '') == 'khong_dat' ? 'checked' : '' }}> Không
                                    đạt</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group-horizontal" style="display: flex; gap: 20px;">
                                <label><input type="radio" name="de_nghi" value="duoc_bao_ve"
                                        {{ ($firstDiem->de_nghi ?? '') == 'duoc_bao_ve' ? 'checked' : '' }}> Được bảo
                                    vệ</label>

                                <label><input type="radio" name="de_nghi" value="khong_bao_ve"
                                        {{ ($firstDiem->de_nghi ?? '') == 'khong_bao_ve' ? 'checked' : '' }}> Không bảo
                                    vệ</label>

                                <label><input type="radio" name="de_nghi" value="bo_sung"
                                        {{ ($firstDiem->de_nghi ?? '') == 'bo_sung' ? 'checked' : '' }}> Bổ sung</label>
                            </div>
                        </div>
                    </div>
